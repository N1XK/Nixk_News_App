...
//    private val onItemOptionsMenuClickListener: OnItemOptionsMenuClickListener
    ...
    interface OnItemOptionsMenuClickListener {
        fun onItemOptionsMenuClicked(position: Int)
    }
